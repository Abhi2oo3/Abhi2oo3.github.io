...
const TestimonialsCarousel = ({ className = '' }: TestimonialsCarouselProps) => {
  ...
  const testimonials: Testimonial[] = [
  {
    ...
    alt: 'Professional headshot of Indian man with short black hair in navy blue suit smiling at camera',
  ...
  },
  {
    ...
    content: 'Abhishek\'s full-stack development skills are outstanding. He built our e-commerce platform from scratch, implementing features that increased user engagement by 35% within the first quarter.',
    rating: 5
  }];
  ...
  console.log('Current testimonial image (src):', currentTestimonial.image);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl sm:text-5xl font-bold text-text-primary">
            Client <span className="bg-gradient-to-r from-brand-cyan to-brand-purple bg-clip-text text-transparent">Testimonials</span>
          </h2>
